...
public:
    ...
    virtual void updateLbExplanationForVariable( unsigned variable,
                                                 const SparseUnsortedList &explanation ) = 0;
    virtual void updateUbExplanationForVariable( unsigned variable,
                                                 const SparseUnsortedList &explanation ) = 0;
